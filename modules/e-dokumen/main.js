// modules/e-dokumen/main.js - FIXED - Multi Feature Router - Taat v3
// Repo path: sd134kalumpang/modules/e-dokumen/main.js
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // PERBAIKAN: Mapping yang benar - setiap fitur load file masing-masing
...
function loadFeature(key){
  ...
  script.onerror = ()=>{
    container.innerHTML = '<div class="card" style="padding:20px;background:white;"><h3>File features/'+key+'.js 404</h3><p>Path GitHub harus: <code>sd134kalumpang/modules/e-dokumen/features/'+key+'.js</code></p><a href="./index.html?fitur=arsip" style="background:#0d3b66;color:white;padding:8px 12px;border-radius:8px;">Reload</a></div>';
  };
